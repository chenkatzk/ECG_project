...
def plot_loss(train_list,validation_list):
    ...
    num_of_epochs=len(train_list)
    x_axis= range(1,num_of_epochs+1)
    plt.plot(x_axis,train_list,label="train loss")
    plt.plot(x_axis,validation_list,label="validation loss")
    plt.title("train and validation loss vs epoch num")
    plt.xlabel('Epoch num')
    plt.ylabel('loss')
    plt.legend( loc='upper left')
    plt.savefig('results/train_and_validation_loss_vs_epoch_num.png')
...
if __name__ == "__main__":
    ...
    print('the train folds are:',train_folds)
    print('the validation folds are:',val_folds)
    print('the test folds are:',test_folds)
